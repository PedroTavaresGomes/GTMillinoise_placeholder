...
def get_dataset_split(split_number):
    ...
    if (split_number == 99): # Split 11 - minus scne 6
        test_npy_files =  [ 53,67,74,61,6,64,70,50,56,57] 
    ...
    if (split_number == 14): # Split 13
        #test_npy_files =  [68,77,84,95,87, 98,93,86,75,65,62,4,49,7,51,72] # test + val
        test_npy_files =  [3,4,6,7,8,49,50,53,54,55] # test + val
        
    if (split_number == 15): # Split 14
        test_npy_files =  [71,72,73,74,76,77,79] # test

    if (split_number == 16): # Split 16
        test_npy_files =  [71,72,73,76,77,79] # test + val
        
    if (split_number == 4): # Split 16
        test_npy_files =  [57,58,59,61,62,63,65,66,67,70]   # test- without val
        

        
    if (split_number == 17): # Split 17--> Scene 1,2,3
        #test_npy_files =  [68,77,84,95,87, 98,93,86,75,65,62,4,49,7,51,72] # test + val
        test_npy_files =  [4,6,7,8,49,50,53,54,55,56] # test + val
